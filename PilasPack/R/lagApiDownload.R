...
lagApiDownload<-function(email, password, from, to, format=FALSE){




  base_url="https://bioportal.salud.gov.pr/api/administration/reports/orders/lag-and-omitted-values"
