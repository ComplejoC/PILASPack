...
#' @examples
#' interviewsApiDownloadAll(email, password, from, to)
#' Datos_all=interviewsApiDownloadAll(my_email, my_password,"2021-01-01", "2021-03-15")
#' ---format defaults to FALSE, as format function not yet implemented for interviews ---

interviewsApiDownload<-function(email, password, from, to, format=FALSE){




  base_url="https://bioportal.salud.gov.pr/api/administration/reports/cases/interviews"
  Datos_all_list=list()
